...
Work on this project began with a moderately-featured, little-used GUI for libmapper known as Webmapper. The interface was created at the IDMIL as a multi-platform replacement for the Max/MSP GUI. It was thought that a browser-based approach would greatly simplify the process of creating cross-compatibility with all major operating systems and perhaps even mobile devices. 
