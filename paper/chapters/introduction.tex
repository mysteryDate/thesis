...
The contribution of this thesis work are the exploration of issues related to user interface design, specifically those built to handle a great deal of information and be adaptable to a variety of uses; the design and implementation of an interface for libmapper that aims to improve on usability and flexibility of the system; and this thesis document, which describes the research and development therein.
