...
libmapper was created at the Input Devices and Music Interaction Laboratory (IDMIL) in response to the challenges of collaborative musical mapping \shortcite{malloch}. As summarized in its website:
...
In its most basic state, libmapper takes the form of an application programming interface (API). APIs require input in the form of text
